...
<recipe>
  ...
  <instantiate from="src/app_package/Module.kt.ftl" to="${escapeXmlAttribute(srcOut)}/${className}Modules.kt" />
  ...
  <open file="${escapeXmlAttribute(srcOut)}/${className}Modules.kt" />
